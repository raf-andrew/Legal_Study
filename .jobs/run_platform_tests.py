...
class PlatformTestRunner:
    ...
    def generate_report(self, output_format: str = "text") -> str:
        ...
        if output_format == "json":
            ...
            report = []
            report.append(f"Platform Test Report - {self.results['timestamp']}")
            ...
            html = [
                ...
                "</head>",
                "<body>",
                f"<h1>Platform Test Report - {self.results['timestamp']}</h1>",
...
def main():
    ...
    with open(f"reports/platform_tests_{timestamp}.json", "w") as f:
        json.dump(runner.results, f, indent=2)
    
    # Save HTML report
    html_report = runner.generate_report("html")
    with open(f"reports/platform_tests_{timestamp}.html", "w") as f:
        f.write(html_report)
