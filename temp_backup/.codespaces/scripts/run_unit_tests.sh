...
run_tests() {
    ...
    python -m pytest "tests/unit/$test_suite" \
        --html="$report_file" \
        --self-contained-html \
        --cov="app" \
...
# Main test execution
echo "Starting comprehensive unit testing..."
...
# Run utility tests
run_tests "utils"
verify_checklist "utils"

# Run deployment tests
run_tests "deployment"
verify_checklist "deployment"

# Run self-healing tests
run_tests "self_healing"
verify_checklist "self_healing"
