"""
Script to run sniffing infrastructure in test mode.
"""
import argparse
import asyncio
import logging
...
class TestRunner:
    """Class for running sniffing infrastructure in test mode."""
    ...
    async def run(
        ...
        try:
            ...
            logger.error(f"Error running test mode: {e}")
            raise
...
def main() -> None:
    ...
    try:
        ...
        parser = argparse.ArgumentParser(
            description="Run sniffing infrastructure in test mode"
        )
        parser.add_argument(
            "--domains",
            type=str,
