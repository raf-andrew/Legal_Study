"""
Script to run sniffing infrastructure in all modes.
"""
import argparse
import asyncio
import logging
...
class AllRunner:
    """Class for running sniffing infrastructure in all modes."""
    ...
    async def run(
        ...
        try:
            ...
            logger.error(f"Error running all modes: {e}")
            raise
...
def main() -> None:
    ...
    try:
        ...
        parser = argparse.ArgumentParser(
            description="Run sniffing infrastructure in all modes"
        )
        parser.add_argument(
            "--domains",
            type=str,
