...
logger = logging.getLogger("run_domains_files_options_output_format_log_file_format_rotation_compression_encoding_mode_delay_buffering_filters_handlers")
...
class DomainFileOptionOutputFormatLogFileFormatRotationCompressionEncodingModeDelayBufferingFiltersHandlersRunner:
...
def main() -> None:
    ...
    try:
        ...
        # Get log handlers
        log_handlers = get_log_handlers(args, log_filters)
        ...
        # Run in specific mode with specific configuration and specific domains and files and specific options and specific output and specific format and specific log level and specific log file and specific log format and specific log rotation and specific log compression and specific log encoding and specific log mode and specific log delay and specific log buffering and specific log filters and specific log handlers
        global runner
        runner = DomainFileOptionOutputFormatLogFileFormatRotationCompressionEncodingModeDelayBufferingFiltersHandlersRunner(args.mode, args.config, domains, files, options, args.output, args.format, args.log_level, args.log_file, args.log_format, args.log_max_bytes, args.log_backup_count, args.log_compress, args.log_encoding, args.log_mode, args.log_delay, args.log_buffering, log_filters, log_handlers)
