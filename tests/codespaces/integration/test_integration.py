...
class TestCodespacesIntegration:
    """Test suite for Codespaces integration testing."""
    ...
    def test_codespace(self, docker_client):
        ...
        container = docker_client.containers.run(
            ...
            name="test_integration_codespace",
            detach=True,
            environment={
    ...
    def test_codespace_creation(self, test_codespace):
        ...
        assert test_codespace.name == "test_integration_codespace"
    ...
    def test_environment_variables(self, test_codespace):
        ...
        assert "TEST_NAME=integration_test" in env
    ...
    def test_cleanup(self, test_codespace):
        ...
        with pytest.raises(docker.errors.NotFound):
            docker.from_env().containers.get("test_integration_codespace")
